  ...
  const handleSignIn = e =>{
    ...
    return (
      <div className='flex justify-center  items-center min-h-screen bg-slate-200'>
          ...
          <h1 className='text-center text-3xl font-bold text-black p-5'>Sing In</h1>
          <div className="card bg-base-100 w-full shrink-0 shadow-2xl">
            <div className="card-body">
              <fieldset className="fieldset">
                <label className="fieldset-label text-2xl">Email</label>
                <input type="email" className="input w-full p-6 text-2xl" placeholder="Email" name='email' />
                <label className="fieldset-label text-2xl">Password</label>
                <input type="password" className="input w-full text-2xl" placeholder="Password" name='password' />
